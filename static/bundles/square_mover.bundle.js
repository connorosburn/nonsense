...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Vector_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Vector.js */ \"./javascript/square_mover/Vector.js\");\n/* harmony import */ var _Rectangle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Rectangle.js */ \"./javascript/square_mover/Rectangle.js\");\n\n\nlet blah = 333 / 0;\nconsole.log(blah);\nlet canvas = document.getElementById('stupid-square-mover');\ncanvas.height = canvas.clientHeight;\ncanvas.width = canvas.clientWidth;\nlet heldKeys = [];\ndocument.addEventListener('keydown', e => {\n  if (!heldKeys.includes(e.code)) {\n    heldKeys.push(e.code);\n  }\n});\ndocument.addEventListener('keyup', e => {\n  heldKeys = heldKeys.filter(k => k != e.code);\n});\n\nwindow.onblur = () => {\n  heldKeys = [];\n};\n\nlet meRect = new _Rectangle_js__WEBPACK_IMPORTED_MODULE_1__.default({\n  color: '#007F00',\n  position: new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(0, 0),\n  size: new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(canvas.height / 15, canvas.width / 15)\n});\nlet otherRect = new _Rectangle_js__WEBPACK_IMPORTED_MODULE_1__.default({\n  color: 'purple',\n  position: new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(canvas.width / 2, canvas.height / 2),\n  size: new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(canvas.width / 10, canvas.height / 10)\n});\nconst frameRate = 250;\nconst speed = 0.2;\n\nconst attemptMove = o => {\n  if (!new _Rectangle_js__WEBPACK_IMPORTED_MODULE_1__.default({\n    position: meRect.getPosition().add(o),\n    size: meRect.getSize()\n  }).intersects(otherRect)) {\n    meRect.move(o);\n  } else {\n    alert('GTFO GREEN');\n  }\n};\n\nconst interval = 1000 / frameRate;\nsetInterval(() => {\n  let directionVector = new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(0, 0);\n  heldKeys.forEach(k => {\n    switch (k) {\n      case 'KeyW':\n        directionVector = directionVector.add(new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(0, -1));\n        break;\n\n      case 'KeyS':\n        directionVector = directionVector.add(new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(0, 1));\n        break;\n\n      case 'KeyA':\n        directionVector = directionVector.add(new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(-1, 0));\n        break;\n\n      case 'KeyD':\n        directionVector = directionVector.add(new _Vector_js__WEBPACK_IMPORTED_MODULE_0__.default(1, 0));\n        break;\n    }\n  });\n  const offset = directionVector.unitVector().multiply(interval).multiply(speed);\n  attemptMove(offset);\n  let context = canvas.getContext('2d');\n  context.fillStyle = 'white';\n  context.fillRect(0, 0, canvas.width, canvas.height);\n  meRect.render(context);\n  otherRect.render(context);\n}, interval);\n\n//# sourceURL=webpack://nonsense/./javascript/square_mover/index.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("920fb766260db2d69e24")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "nonsense:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatenonsense"] = (chunkId, moreModules, runtime) => {
